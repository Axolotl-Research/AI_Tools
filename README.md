...
└── Internship/
    ...
    └── Library/                                 ← Curated reading from the Axolotl Research library
        ...
        ├── Domain-B-Tokenization/               ← Asset tokenization & cryptocurrencies
        ...
        ├── Probabilistic-Thinking/              ← Deterministic vs. probabilistic compute
        ├── Cognition-Extended-Mind/              ← AI workflow transformation, writing craft
...
| Intern | Domain | Focus |
|--------|--------|-------|
| Intern A | Fermented Food Systems & Swiss Food Ecosystem | Production methods, fermentation taxonomy, Swiss food network |
| Intern B | Asset Tokenization & Cryptocurrencies | Token standards, smart contracts, DeFi protocols, regulatory frameworks |
