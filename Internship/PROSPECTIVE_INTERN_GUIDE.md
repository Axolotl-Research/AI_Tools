---
title: "The Axolotl Summer Internship — What to Expect"
audience: [prospective-interns]
...
### The Deliverable: An Imaginary Business Case Study

Your capstone deliverable is a GitHub repository containing an **imaginary business case study** — a narrative-driven exploration of your domain through a fictional company, product, or intervention.

**What this means:** You are telling a story. The story follows a fictional organization (a startup, a cooperative, a research lab, a regulatory body) as it navigates real challenges in your domain. Every domain fact in the story — the microbial pathway, the token standard, the regulatory requirement, the market structure — must be grounded in the entities and relationships you researched during the program. The fictional framing is a storytelling vehicle, not a license to fabricate.

Your case study might look like one of these:

- **Intern A (Fermented Foods):** A Swiss startup sets out to design a family of probiotic lifecycle products spanning both food and cosmetics. The product line targets distinct life stages and health dimensions: a fermented infant formula or supplement for colicky babies (drawing on approaches like Suri Biotech's), a lacto-bacteria recovery drink for athletes (leveraging lactic acid breakdown), a microbiome-repopulation product for older adults recovering from C. diff during and after antibiotic treatments, and a topical probiotic skincare line for microbiome maintenance. The case explores the science behind each product, how the startup navigates the Swiss startup ecosystem (Innosuisse, EPFL/ETHZ spinoff resources, Swiss food and cosmetics regulation), sourcing and fermentation methods, clinical evidence (traditional knowledge and published research), and go-to-market strategy across Swiss and EU markets. Supporting materials: ER diagrams of the probiotic-strain-to-health-outcome network across life stages, a CSV of Swiss fermentation and biotech startups, and a mermaid flowchart of the regulatory pathway for novel food and cosmetic product approval.

- **Intern B (RWA Tokenization):** A small Swiss real estate developer wants to raise capital for a multi-unit residential project. Traditionally, they would go through an investment bank for securitization — expensive, document-heavy, slow, and inaccessible at their scale. Instead, they tokenize shares in a real estate partnership: investors subscribe via a smart contract, receive tokens representing fractional ownership, and distributions (rental income, eventual sale proceeds) are paid automatically on-chain. The case compares tokenization against traditional securitization head-to-head — cost to set up, legal documentation burden, speed to close, investor onboarding (KYC/AML), ongoing payment distribution, and secondary market liquidity. Supporting materials: a testnet deployment of the token and distribution contract, ER diagrams of the ownership and payment-flow model, a side-by-side cost/timeline comparison table, and a mermaid flowchart of the traditional securitization pipeline vs. the tokenized alternative.

The format is flexible. You might write a markdown document with sections for company background, problem statement, analysis, and decision points. You might build a website that walks readers through the case interactively. You might include a companion program that demonstrates part of the case mechanically (a token deployment, a data pipeline). A **hybrid** combining narrative with ER diagrams and code is encouraged.
...
**Mid-program inflection point:** At Week 4, you'll receive a domain-specific mid-program analysis ([`ANALYSIS_INTERN_A.md`](ANALYSIS_INTERN_A.md) or [`ANALYSIS_INTERN_B.md`](ANALYSIS_INTERN_B.md)) that applies four analytical methodologies (grill-me, essentialist, hypothesis-framer, superforecasting) to your case study framing. This is not an evaluation — it's a navigational tool designed to help you make scope decisions, sharpen your central argument, and converge on a defensible case study for the remaining four weeks. Read it. Challenge it. Bring it to curation.
...
**AI literacy.** Not just "I used ChatGPT a few times." You will understand Git and GitHub workflows. You will know how to prompt LLMs effectively and evaluate their outputs critically. You will have hands-on experience with the model ecosystem, MCP tools, agent skills (including grill-me), and protocols like IBM ACP (Agent Client Protocol) and A2A (Agent-to-Agent, Linux Foundation). You will understand the difference between deterministic and probabilistic compute, and you will have developed the discernment to know which kind of problem belongs to which kind of tool. You will be able to draw entity-relationship diagrams to map and communicate complex domains. You will have seen firsthand how AI is reshaping workflows — because you will have used it to reshape your own.
