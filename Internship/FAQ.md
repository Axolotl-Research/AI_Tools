...
- You do not need to cover everything in your domain. The deliverable is a case study, not an encyclopedia.
...
## Case Study Construction (Week 4+)

### What is the mid-program analysis, and should I read it?

At Week 4, the program shifts from broad entity collection to focused case study construction. Two analysis documents were produced to help navigate this inflection point:

- [`ANALYSIS_INTERN_A.md`](ANALYSIS_INTERN_A.md) — for the probiotic lifecycle case study
- [`ANALYSIS_INTERN_B.md`](ANALYSIS_INTERN_B.md) — for the tokenization vs. securitization case study

These analyses apply four methodologies (grill-me, essentialist, hypothesis-framer, superforecasting) to your case study framing. They are designed to help you ASK better questions — not to give you answers. Read yours at the start of Week 4, then bring your questions to curation.

### How do I decide what to cut from my case study?

This is the hardest question at Week 4. Start with your mid-program analysis document — it includes a "Week 4 Audit" of self-assessment questions and a "Convergence Decision" section that maps the tradeoffs. Then create a `SCOPE_DECISION.md` in your repo that commits to: (1) what you're keeping, (2) what you're cutting, (3) why. Bring this to your next curation review. Research professionals can validate or challenge your scope decision.

### How do I build the case study narrative?

Your mid-program analysis includes a narrative structure template with suggested sections and page counts. But the real work is: (1) decide what your case study is actually ARGUING — one sentence; (2) build the evidence sections from your entity collection; (3) design 2-3 decision points where the reader must engage with domain tradeoffs. The PROMPT_CHEAT_SHEET.md has a "Case Study Narrative Construction" section with prompts for scenario brainstorming, narrative-from-entities, and decision-point design.

### What if I disagree with the mid-program analysis?

Good. The analysis is a sparring partner, not an oracle. It was produced by a sub-agent with no access to your actual research. It may have missed evidence you've collected. It may have over-pruned. It may have underestimated what's achievable. The right response is: "I read the analysis. Here's where I agree. Here's where I disagree. Here's why." Bring that to curation.

### How do I prepare for grill-me at the end?

The mid-program analysis includes escalating grill-me self-test questions (Recall → Mechanism → Rationale → Edge Cases → Synthesis). Use them. But also: load the actual grill-me skill (`~/.agents/skills/grill-me/SKILL.md`) into your AI tool and run it against your draft. The skill is more thorough than the self-test questions alone. Do your first grill-me run at Week 7 — not Week 8. You need time to address what it finds.
...
| Unsure how to scope my case study (Week 4+) | Read your ANALYSIS_INTERN_*.md; create SCOPE_DECISION.md | Bring SCOPE_DECISION.md to curation |
| Case study narrative won't come together | PROMPT_CHEAT_SHEET.md "Case Study Narrative" section; grill-me self-test | WhatsApp |
