...
| Intern | Domain | Syntax Focus | Semantics Focus |
|--------|--------|-------------|-----------------|
| Intern A | Fermented Food Systems & Swiss Food Ecosystem | Production methods, techniques, Swiss production systems | Fermentation taxonomy, food safety, Swiss business network, Swiss research institutions |
| Intern B | Asset Tokenization & Cryptocurrencies | Token standards (ERC-20/721/1155), smart contracts, DeFi protocols | Tokenization models, regulatory frameworks, economic models, market structures |
