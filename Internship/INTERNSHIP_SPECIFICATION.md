...
graph TB
    ...
    subgraph DomainA["Summer 2026 — Domain A"]
        FERMENT[Fermented Foods<br/>Microbes & Human Health]
    end

    subgraph DomainB["Summer 2026 — Domain B"]
        RWA[Real-World Asset<br/>Tokenization]
    end
...
| `RWA` | Concept | Real-World Asset — a physical or traditional financial asset (real estate, commodities, private equity, bonds, intellectual property) represented as a digital token on a blockchain. Central to Domain B's focus. |
| `microbiome` | Concept | The community of microorganisms (bacteria, fungi, viruses) that inhabit a particular environment — in Domain A's context, the microbial communities present in fermented foods and their interaction with the human gut microbiome. |
| `nutrient-pathway` | Concept | The biochemical route through which a nutrient from fermented food is transformed, absorbed, and utilized by the human body — a key relationship axis in Domain A's entity-relationship framework. |

### 1.3 Domain Scope — Summer 2026

#### Domain A: Fermented Foods, Microbes, Nutrients & Human Health

| Dimension | Scope |
|-----------|-------|
| **Syntax** | Fermentation microbiology (organisms, strains, metabolic pathways), production methods and techniques, nutrient composition analysis, Swiss food production systems |
| **Semantics** | Microbial ecology of fermented foods, nutrient-health pathway mapping (how specific microbes and nutrients affect human health outcomes), food safety frameworks, Swiss food business network, Swiss research institution landscape |
| **Temporal** | How AI/automation is changing fermentation processes and nutrient analysis; evolution of microbiome science; shifting health claims and food regulations |
| **Narrative** | **Imaginary business case study** — a story-driven exploration of designing a family of probiotic lifecycle products for a startup Swiss food and cosmetics company. The case follows the startup as it draws on the Swiss startup ecosystem, traditional knowledge, and scientific research to develop products targeting distinct life stages: colicky babies (e.g., Suri Biotech's approach to infant gut health), athletes (lacto-bacteria breaking down lactic acid for recovery), older adults recovering from C. diff (microbiome repopulation during and after antibiotic treatments), and skin health (topical probiotic/living cosmetics for microbiome maintenance). The case explores product design, regulatory pathways, sourcing and fermentation science, and go-to-market strategy across Swiss and EU markets. |
...
#### Domain B: Real-World Asset (RWA) Tokenization

| Dimension | Scope |
|-----------|-------|
| **Syntax** | Token standards (ERC-20, ERC-721, ERC-1155) for representing physical and financial assets, smart contract deployment for fractional ownership, blockchain infrastructure for asset settlement |
| **Semantics** | Asset valuation frameworks for tokenized RWAs, regulatory models (securities law, property law, cross-border compliance), custody and ownership models, market structures for tokenized assets, economic models of fractional ownership |
| **Temporal** | Evolution of token standards toward RWA interoperability, shifting regulatory landscapes for tokenized securities, AI's role in asset valuation and token analysis, convergence of traditional finance (TradFi) and decentralized finance (DeFi) |
| **Narrative** | **Imaginary business case study** — a story-driven exploration of how tokenization and digital assets are displacing traditional securitization. The case follows a fictional small real estate developer who uses tokenization as a lower-cost, low-documentation, more efficient alternative to traditional securitization for organizing an investment group and managing investor payments. Focus: how tokenization replaces the investment banking securitization pipeline for smaller real estate partnerships — comparing cost, speed, documentation burden, investor access, and payment distribution against the traditional model. |
| **Domain Expert** | Ivan (fermented food + software architecture + cryptocurrencies) |
| **Business Context** | Matt (domain business expert) |
| **AI Methodology** | Mario (AI research agents) |
...
| **4-5** | **Curation-I** | Research professional batch review of W1-4 artifacts, gap identification, direction adjustment. **Scope inflection point:** interns read their domain-specific mid-program analysis ([`ANALYSIS_INTERN_A.md`](ANALYSIS_INTERN_A.md) or [`ANALYSIS_INTERN_B.md`](ANALYSIS_INTERN_B.md)), complete the Week 4 self-audit, and create a `SCOPE_DECISION.md` committing to what's in and what's out for the remaining weeks. | All artifacts through at least one curation cycle; revise actions identified and in progress; scope decision documented |
...
| **6-7** | **Synthesis** | Framework development — syntax/semantics/temporal analysis, cross-artifact integration, case study narrative construction (scenario design, character/org framing, plot structure grounded in research) | Draft of capstone deliverable; framework structure visible in repo; case study narrative draft begun |
...
| Option | Example |
|--------|---------|
| **Imaginary business case study** | A narrative-driven case study following a fictional company, product, or intervention through real domain challenges — grounded in researched entities, relationships, and temporal trends |
...
| **Hybrid** | Any combination of the above — e.g., a case study narrative with embedded ER diagrams and a companion smart contract or data pipeline |

The **preferred deliverable** for Summer 2026 is the imaginary business case study. This format channels entity collection and relationship mapping into a coherent, memorable narrative — the kind of artifact that demonstrates both domain depth and communication skill. The case study should be grounded in the entities, relationships, and temporal trends researched during the program; the fictional framing is a storytelling vehicle, not a license to fabricate domain facts.
...
4. For case studies: the narrative is coherent, the fictional framing serves the domain education (not the reverse), and every domain claim in the story is backed by researched entities and relationships
5. The grill-me skill is the quality standard — if the intern can defend their work through Socratic questioning, the deliverable meets the bar
