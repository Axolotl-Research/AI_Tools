...
### Case Study Narrative Construction

| Goal | Prompt |
|------|--------|
| **Scenario brainstorming** | "I'm writing an imaginary business case study about [domain]. My researched entities and relationships are: [list key entities and relationships]. Brainstorm 3-5 fictional scenarios (companies, products, interventions) that could serve as the narrative vehicle for this domain knowledge. For each: the protagonist organization, the problem they are solving, and why this scenario would let me showcase the most important domain concepts." |
| **Case study structure** | "Help me outline an imaginary business case study. I want to follow a structure like: (1) Company/Setting Background, (2) The Problem/Opportunity, (3) The Technical/Scientific Challenge, (4) The Regulatory/Market Context, (5) Decision Points, (6) Outcomes/Implications. For my domain [domain], what should go in each section? Map my key entities and relationships to each section." |
| **Character / Org development** | "Develop a fictional [company/startup/cooperative/research lab] for my case study on [domain]. Give it: a name, founding story, location, team, mission, and the specific problem it is trying to solve. Ground every detail in real domain entities and trends I've researched." |
| **Narrative from entities** | "Here are the 15 most important entities in my domain framework: [list them]. Here are the key relationships: [list them]. Write a narrative scenario — a short story — that brings at least 8 of these entities to life through a business or scientific challenge. The story should feel real, not like a textbook." |
| **Decision-point design** | "Good case studies have decision points — moments where the protagonist must choose between alternatives. For my case study about [scenario], design 3 decision points that force the reader to engage with core domain tradeoffs. For each decision point: the situation, the two or three options, the domain knowledge needed to evaluate them, and the real-world consequences of each choice." |
| **Grounding check** | "Read this case study draft: [paste it]. For every factual claim about the domain, verify it against my researched entities and relationships: [list or paste key artifacts]. Flag any claim that is unsupported, contradicts my research, or fabricates a domain fact. The fiction should be in the characters and scenario, not in how fermentation works or how ERC-721 tokens are deployed." |
| **Case study + ER integration** | "I have a case study narrative about [scenario] and these ER diagrams: [paste or describe them]. Where in the narrative should each diagram appear? Write 2-3 sentences of narrative text that introduces each diagram and tells the reader what to notice." |
