...
- **Low automaticity score:** Habit formation below threshold — return to Starter Kata
...
- **Threshold:** 0.15 (converged when starter drill outcomes indicate stable foundational habit signals and low ambiguity)
- **Max iterations:** 3
