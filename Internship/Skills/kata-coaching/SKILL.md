...
description: >
  ...
  thinking. Used by managers, supervisors, and coaches to coach learners through
...
| Coach during active IK | Learner OR coach |
| Revoke consent mid-session | Learner (any time) |
| Switch to Improvement Kata | Coach |
...
- **Threshold:** 0.15 (converged when the coaching cycle has clear target/current gap framing, prioritized obstacle, concrete next experiment, and feedback timing)
- **Max iterations:** 3
