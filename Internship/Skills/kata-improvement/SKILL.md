...
The challenge comes from the level above you — your organization's strategic objective, your team's goal, or your coach's capability target. Understand it. Don't solution-jump. Just understand: what are we trying to achieve?
...
|--------|----------------------|
| Start Improvement Kata | Coach |
| Continue to next obstacle | Learner (implicit) |
| Switch to Coaching Kata | Learner OR coach |
| Abandon cycle | Coach |
...
- **Threshold:** 0.15 (converged when all four steps are coherent, experiment is testable, and feedback timing is defined)
- **Max iterations:** 3
