...
Use the deep-module deletion test methodology or manual deletion test reasoning.
...
Use the deep-module surface assessment methodology or manual surface count.
...
Apply coding-guidelines methodology with focus on single-use abstraction violations (Simplicity First, anti-pattern #2).
...
- General deep-module design principles — For G1 (deletion test) and G2 (surface count, depth score)
- General coding-guidelines principles — For G3 (single-use abstraction audit, Simplicity First violations)
...
Follow the 3-gate process with the same recursion rules in any environment.
...
- **Threshold:** 0.25 (converged when no material eliminations remain)
- **Max iterations:** 3
