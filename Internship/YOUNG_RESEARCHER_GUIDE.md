...
You are a beginner researcher working with beginner tools. You have a specific job: **collect entities, map relationships, and trace change** — all in service of building an **imaginary business case study** that tells a coherent, domain-grounded story about your subject. The first half of the program (Weeks 1-4) is about finding and describing the things that exist in your domain — the entities. The second half (Weeks 5-8) is about discovering how those entities connect — the relationships — drawing those connections as mermaid ER diagrams, and weaving everything into a narrative. The temporal dimension runs through both halves: how are the entities and relationships changing over time, and what role is AI playing in that change?
